...
import { TMessageItemDB } from 'types'
...
function ChatScreen({}: ChatScreenProps) {
  ...
  const messageSectionRef = React.useRef<HTMLElement>(null!)
  ...
  ) // will be empty when user doesn't exist
  ...
  function sendMessage() {
    ...
    addDoc(getChatMessageColRef<TMessageItemDB>(router.query.id as string), {
